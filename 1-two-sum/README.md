...
<pre class="notranslate"><strong>Input:</strong> nums = [2,7,11,15], target = 9
...
<pre class="notranslate"><strong>Input:</strong> nums = [3,2,4], target = 6
<strong>Output:</strong> [1,2]
</pre>

<p><strong>Example 3:</strong></p>

<pre class="notranslate"><strong>Input:</strong> nums = [3,3], target = 6
<strong>Output:</strong> [0,1]
</pre>
