...
<pre class="notranslate"><strong>Input:</strong> l1 = [2,4,3], l2 = [5,6,4]
...
<pre class="notranslate"><strong>Input:</strong> l1 = [0], l2 = [0]
<strong>Output:</strong> [0]
</pre>

<p><strong>Example 3:</strong></p>

<pre class="notranslate"><strong>Input:</strong> l1 = [9,9,9,9,9,9,9], l2 = [9,9,9,9]
